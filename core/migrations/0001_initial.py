    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', mptt.fields.TreeManyToManyField(help_text='Формат: обязательный', to='core.category', verbose_name='Выбрать категорию к которой привязан данный тип товара')),
            ],
        ),
        migrations.CreateModel(
