...
def set_coupons():
    ...
    mixer.blend(Coupon, code='GTrDe56OPL', valid_from='2022-11-20 22:14:18', valid_to='2023-05-03 22:14:18', count=20)
    mixer.blend(Coupon, code='HU87TgbRR', valid_from='2022-11-20 22:14:18', valid_to='2023-05-03 22:14:18', count=0)
